...
/>
            ...
            <TitleBox title={"gallery"} subtitle={"la Fresca cafe"} button={"view more"} ClassName={"absolute right-0 top-20 right-20 w-[50%] h-[50%]"} URLLink="/gallery" />
            <TitleBox
                title={""}
                subtitle={""}
                button={""}
                ClassName={"absolute left-0 top-60 left-10 w-[50%] h-[60%] bg-cover bg-center bg-[url('https://images.unsplash.com/photo-1414235077428-338989a2e8c0?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')]"}
                URLLink=""
            />
