  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 p-4">
      <div className="bg-white text-green p-6 rounded-lg shadow-lg w-full max-w-md">
        ...
        <div className="mb-2"><strong>Waiter:</strong> {order.waiter}</div>
        <div className="mb-2"><strong>Order:</strong> {order.order}</div>
        <div className="mb-2"><strong>Customer:</strong> {order.customer}</div>
        <div className="mb-2"><strong>orderItems:</strong>dark coffee</div>
        <button 
