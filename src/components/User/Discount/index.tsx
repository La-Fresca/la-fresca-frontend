      ...
      <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 mx-auto max-w-screen-xl mt-10">
        {item.map((_: any) => {
          return (
            ...
            >
              <div
                className="dark:border rounded-2xl border-foodbg bg-foodbg backdrop-blur-md xl:w-[500px] lg:w-[450px] h-[350px] p-2 py-2 mx-[10%] mb-10 overflow-hidden"
                style={{
              ...
              >
                ...
                <div className="px-3 mt-2">
                  ...
                  <hr className="mt-4 mb-3 border-foodbg" />
