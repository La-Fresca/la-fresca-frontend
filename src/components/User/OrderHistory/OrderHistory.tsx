    ...
    orderItems: [
      {
        ...
        price: 3900,
        quantity: 30,
        image: 'https://www.seriouseats.com/recipes/images/2013/07/chocolate-milkshake-hero.jpg' // Image of Chocolate Milkshake
      },
      {
        ...
        price: 1200,
        quantity: 20,
        image: 'https://images.unsplash.com/photo-1578985545062-69928b1d9587?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=60' // Existing image seems relevant
      },
      {
        ...
        price: 1500,
        quantity: 15,
        image: 'https://www.inspiredtaste.net/wp-content/uploads/2020/01/Strawberry-Smoothie-2-1200x800.jpg' // Image of Strawberry Smoothie
      }
    ],
    payment: {
      method: 'Visa',
