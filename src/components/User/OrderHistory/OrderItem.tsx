    ...
    return (
        <div className='w-full flex flex-col md:flex-row justify-between items-center p-4 bg-gray-800 mb-4 rounded-lg shadow-md'>
            ...
            <div className='w-full md:w-2/6 flex flex-col items-end mt-2 md:mt-0'>
                ...
                <p className='text-white text-base font-normal sm:hidden'>Price: ${price}</p>
                <p className='text-white text-lg font-semibold sm:hidden'>Qty: {quantity}</p>
                {/* Show price and quantity without labels on larger devices */}
                <p className='hidden sm:block text-white text-lg font-semibold'>${price}</p>
                <p className='hidden sm:block text-white text-base font-normal'>Qty: {quantity}</p>
            </div>
        </div>
    );
};
