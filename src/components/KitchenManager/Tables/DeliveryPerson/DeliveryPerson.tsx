...
export default function App() {
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex justify-between items-center">
          <span className="text-default-400 text-small">
            Total {deliveryPersons.length} delivery persons
          </span>
        </div>
      </div>
    );
  }, [filterValue, deliveryPersons.length]);
  ...
  return (
    <Table
      aria-label="Delivery Persons table"
      isHeaderSticky
    ...
    >
      ...
      <TableBody
        emptyContent={'No delivery persons found'}
        items={sortedItems}
